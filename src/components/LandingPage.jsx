...
function LandingPage() {
  ...
  return (
    <div className="bg-[#050505] text-white overflow-x-hidden font-display selection:bg-primary selection:text-black">
      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] px-6 py-6 flex justify-between items-center bg-gradient-to-b from-black/50 to-transparent backdrop-blur-sm">
        ...
        <Link to="/login" className="px-6 py-2 border border-white/10 rounded-full text-xs font-black uppercase tracking-widest hover:bg-white/5 transition-all">
          Acessar Sistema
        </Link>
      </nav>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center p-6 pt-20 overflow-hidden">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/5 border border-white/10 rounded-full text-[10px] font-black uppercase tracking-[0.3em] text-primary mb-4 animate-pulse">
          ...
          <p className="text-slate-400 text-base md:text-xl max-w-2xl mx-auto font-medium leading-relaxed px-4">
      ...
      <section id="features" className="py-32 px-6 bg-[#080808]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <motion.div {...fadeInUp} className="space-y-8 text-left">
            ...
            <ul className="space-y-4 pt-4">
              {['Diagnósticos de Perda em Tempo Real', 'Cálculo Automático de ROI', 'Propostas Comerciais que se pagam'].map((item, i) => (
                <li key={i} className="flex items-center gap-3 font-bold text-white uppercase text-xs tracking-widest">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-card-bg border border-white/5 p-8 rounded-[40px] shadow-2xl space-y-8"
          >
            <div className="flex justify-between items-center pb-6 border-b border-white/5">
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Exemplo de Diagnóstico</p>
            ...
            <div className="space-y-6">
              <div className="p-6 bg-black rounded-2xl border border-white/5">
                <p className="text-slate-500 text-xs uppercase font-black mb-2 tracking-widest">Ineficiência Detectada</p>
                <p className="text-xl font-bold text-white uppercase italic">Retrabalho em Planilhas</p>
                <div className="mt-4 flex items-end justify-between">
                  <p className="text-sm text-slate-400">Impacto Financeiro:</p>
              ...
              <div className="p-6 bg-primary/5 rounded-2xl border border-primary/20">
                <p className="text-slate-500 text-xs uppercase font-black mb-2 tracking-widest">Solução Proposta</p>
                <p className="text-xl font-bold text-white uppercase italic">Automação de Processos</p>
                <div className="mt-4 flex items-end justify-between">
      ...
      <section className="py-32 px-6 text-center">
        <motion.div {...fadeInUp} className="mb-20">
          ...
          <p className="text-slate-500 font-medium tracking-widest uppercase text-xs">Tudo o que você precisa para escalar sua consultoria</p>
        </motion.div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div 
              key={i}
              whileHover={{ y: -10 }}
              className="p-10 bg-card-bg border border-white/5 rounded-[40px] text-left group hover:border-primary/30 transition-all shadow-xl"
            >
              <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-8 group-hover:bg-primary/10 transition-all">
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-black/70 text-lg font-bold max-w-xl mx-auto uppercase tracking-widest">
            Junte-se aos consultores que pararam de dar descontos e começaram a gerar lucro.
          </p>
          <div className="pt-6">
            <Link to="/onboarding" className="px-12 py-6 bg-[#0a0a0a] text-primary font-black uppercase text-sm tracking-[0.3em] rounded-2xl hover:scale-105 transition-all shadow-2xl block md:inline-block">
      ...
      <footer className="py-12 px-6 border-t border-white/5 text-center">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2 opacity-50">
            <span className="material-symbols-outlined text-white text-xl font-bold">calculate</span>
            <h1 className="text-sm font-black uppercase tracking-tighter text-white">Gama <span className="text-primary">Calc</span></h1>
          </div>
          <p className="text-[10px] text-slate-600 font-bold uppercase tracking-widest">© 2026 Gama Studio Solutions • Feito para Orquestradores</p>
          <div className="flex gap-6">
            <a href="#" className="text-[10px] text-slate-500 font-bold uppercase hover:text-white transition-colors">Termos</a>
            <a href="#" className="text-[10px] text-slate-500 font-bold uppercase hover:text-white transition-colors">Privacidade</a>
          </div>
        </div>
      </footer>
