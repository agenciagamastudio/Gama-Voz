  ...
  return (
    <div className="min-h-screen bg-gama-dark p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Criança Interior Strategy */}
        <section className="mb-16">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gama-text mb-8">🎯 Estratégia "Criança Interior"</h2>
          <div className="bg-gama-surface rounded-xl p-8 border border-gama-surface-accent space-y-6">
            <div>
              <h3 className="text-2xl font-black text-gama-primary mb-4">
                Reativando Sonhos Através de Narrativas Autênticas
              </h3>
              <p className="text-gama-text-secondary leading-relaxed mb-4">
                GAMA STUDIO não vende apenas marketing ou design. Construímos <span className="text-gama-primary font-semibold">marcas como pontes para realizações</span> — conectando com a "criança interior" do cliente final através de histórias que evocam emoção, aspiração e autenticidade.
              </p>
              <p className="text-gama-text-secondary leading-relaxed">
                Nossa estratégia proprietary é reativar a <span className="text-gama-primary font-semibold">"criança interior"</span> dos clientes finais: aquela parte que sonha, que quer crescer, que busca autenticidade. As marcas que criamos são facilitadores desses sonhos — não apenas produtos, mas <span className="text-gama-primary font-semibold">narrativas que transformam</span>.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="bg-gama-surface rounded-xl p-8 border border-gama-surface-accent">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gama-text-secondary">
                <p>
                  O Grupo Gama não constrói marcas genéricas. Construímos marcas que conquistam mercado através de metodologias proprietárias, execução rigorosa e estratégia clara — sempre conectando com a "criança interior" do cliente final.
                </p>
                <p>
                  Cada marca que criamos é um sistema vivo: com DNA próprio, lógica de expansão, diretrizes visuais rigorosas e um roadmap de domínio de mercado. Mas por trás de tudo está a narrativa que faz as pessoas sentirem algo real.
                </p>
                <p>
                ...
                <p>
                  Shipped is better than perfect. Mas "shipped" na Gama significa entrega de valor + impacto emocional, não degradação de qualidade.
                </p>
              </div>
            </div>
          </div>
