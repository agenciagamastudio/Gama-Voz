    ...
    <>
      ...
      >
        ...
        <div className="flex-shrink-0 px-4 py-5 border-b border-gama-surface flex items-center justify-between">
          <Link href="/landing" className="flex items-center gap-2 hover:opacity-80 transition-opacity flex-1 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-gama-text-muted truncate">Design</p>
            </div>
          </Link>
