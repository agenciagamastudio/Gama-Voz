...
export default function LandingPage() {
  ...
  useDustParticles(heroRef, 600)

  const parallaxTransform = `translateY(${scrollY * 0.5}px)`

  return (
    <div className="min-h-full bg-gama-dark relative">
      {/* Full-page volumetric animated background */}
      <div className="absolute inset-0 pointer-events-none z-0 w-full" style={{ minHeight: '100%' }}>
        {/* Top-left massive blob */}
        <div
          className="absolute -top-96 -left-96 w-[800px] h-[800px] bg-gama-primary rounded-full mix-blend-screen filter blur-[120px]"
          style={{
        ...
        {/* Bottom-right massive blob */}
        <div
          className="absolute -bottom-96 -right-96 w-[900px] h-[900px] bg-gama-primary rounded-full mix-blend-screen filter blur-[120px]"
          style={{
        ...
        {/* Center subtle blob */}
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gama-primary rounded-full mix-blend-screen filter blur-[150px]"
          style={{
            opacity: 0.15
          }}
        ></div>
      ...
      <header className="sticky top-0 z-40 border-b border-gama-surface bg-gama-darker/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link href="/components/atoms">
            <Button variant="secondary" size="sm">BrandBook</Button>
          </Link>
        </div>
      </header>

      {/* Hero com Parallax */}
      <section ref={heroRef} className="vol-light relative min-h-screen flex items-center justify-center overflow-hidden py-20">
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          <div className="inline-block mb-6 animate-bounce" style={{ animationDuration: '2s' }}>
            <Badge variant="success" size="sm"><GamaLogo size="sm" className="inline mr-1" /> BrandBook Pro</Badge>
          </div>

          <H1 className="text-6xl md:text-7xl text-gama-text mb-6 leading-tight">
            BrandBook que <span className="text-gama-primary">Vende</span>
            <br />
        ...
        <div className={`transition-all duration-1000 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {[
              ...
              >
                <div
                  className="glass-card liquid-edge rounded-2xl p-6 hover:shadow-lg transition-all group cursor-pointer h-full"
                >
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 border-t border-gama-surface/30">
        <div className="relative max-w-2xl mx-auto">
          ...
          <div
            className="glass-card liquid-edge rounded-3xl p-12 shadow-lg hover:shadow-2xl transition-all duration-500"
          >
            <div className="text-center">
              ...
              <div className="mt-8 inline-flex items-center gap-2 px-6 py-3 rounded-full" style={{ background: 'rgba(136, 206, 17, 0.15)', border: '1px solid rgba(136, 206, 17, 0.3)' }}>
                <span className="text-sm font-bold text-gama-primary flex items-center gap-2">
                  <span className="inline-block w-2 h-2 rounded-full bg-gama-primary animate-pulse" />
                  Em produção
                </span>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gama-text-secondary mb-8">
                Explore o BrandBook GAMA funcionando em tempo real. Todos os componentes documentados, animados, acessíveis.
              </p>
              <Link href="/components/atoms">
            ...
            <div className="relative">
              ...
              <div
                className="glass-card liquid-edge relative rounded-2xl p-12 flex flex-col items-center justify-center min-h-64"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 w-full max-w-xs">
      ...
      <section ref={benefitsRef} className="max-w-7xl mx-auto px-6 py-24 border-t border-gama-surface">
        <div className={`transition-all duration-1000 ${benefitsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div
            className="glass-card liquid-edge rounded-3xl p-12"
          >
      ...
      <section id="cta" ref={ctaRef} className="max-w-7xl mx-auto px-6 py-24 border-t border-gama-surface">
        <div className={`transition-all duration-1000 ${ctaVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          <div
            className="glass-illuminated liquid-edge rounded-3xl p-16 text-center relative overflow-hidden"
          >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gama-text-secondary">BrandBooks que escalam.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-gama-text-secondary">
                ...
                <li><a href="/components/atoms" className="hover:text-gama-primary transition-colors">BrandBook</a></li>
          ...
          <div className="border-t border-gama-surface pt-8 text-center">
            <p className="text-xs text-gama-text-muted">© 2026 GAMA BrandBook. Feito com Motion.dev + Design System próprio.</p>
          </div>
        </div>
      </footer>
      </div>
