...
export function Alert({
  ...
  return (
    <div
      className={`${withGlass ? 'glass glass-card liquid-edge border border-white/20' : `glass-card liquid-edge ${color.bg} border ${color.border}`} rounded-xl p-4 flex gap-3 motion-enter-slide`}
      role="alert"
